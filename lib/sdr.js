...
// Defensive justcall_calls field access (column names finalize with the sync).
const callTime = (c) => c.call_time || c.initiated_at || c.started_at || c.call_date || c.created_at || c.time || null;
