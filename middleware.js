...
export const config = {
  matcher: ["/", "/outbound/:path*", "/queue/:path*", "/inbound/:path*", "/ae/:path*", "/sdr/:path*", "/tam/:path*", "/goals/:path*", "/health/:path*", "/api/queue/:path*", "/api/tam/:path*", "/api/settings/:path*", "/api/rep-goals/:path*", "/api/sdr-targets/:path*"],
};
