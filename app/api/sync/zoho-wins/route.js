...
// Scoped to the current quarter only, so the set is small — 60s is plenty even
// with per-deal contact lookups for blank-website deals.
...
export async function GET(request) {
  ...
  try {
    ...
    // Only this quarter's Closed Won deals — keeps the pull tiny and fast.
